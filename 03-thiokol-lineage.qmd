...
```{mermaid}
%%| label: fig-thiokol-chain
%%| fig-cap: "Thiokol ownership chain, 1929–present. The Promontory, UT facility has operated continuously under all six corporate names."
flowchart TD
